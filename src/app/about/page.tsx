...
export const metadata: Metadata = {
  ...
  description:
  "Syed Muhammad Ahmad Bukhari - Founder of AiXCEL Solutions. Building autonomous AI systems and enterprise automation for businesses ready to scale without scaling headcount.",
  openGraph: {
