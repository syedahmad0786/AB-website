...
const SERVICE_IMAGES: Record<string, string> = {
  "agentic-ai": "/images/services/agentic-ai.png",
  "voice-ai": "/images/services/voice-ai.png",
...
function ServiceDetail({
  ...
  {/* Service Visual */}
  <div className="mt-8 relative aspect-[16/9] rounded-xl overflow-hidden border border-white/[0.04]">
  <Image
  src={SERVICE_IMAGES[service.id] || ""}
  alt={`${service.title} - System Architecture`}
  fill
  quality={90}
