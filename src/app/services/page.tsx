...
export const metadata: Metadata = {
  ...
  description:
    "Custom AI automation services: Agentic AI workflows, Voice AI agents with <500ms latency, content generation pipelines, enterprise integrations via n8n/Make, and AI consulting through Fynora.ai. ROI-focused solutions for scaling businesses.",
  openGraph: {
