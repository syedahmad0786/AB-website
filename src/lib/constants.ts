...
export const SERVICES = [
  ...
  description:
  "We deliver strategic AI implementation, workforce training, and internal tool development. From fractional Chief AI Officer services to hands-on team enablement \u2014 your team learns to build, not just use.",
  useCase: {
...
export const TRUSTED_BY = [
  ...
  "a global media investment group",
  "an AI startup incubator",
  "a global staffing marketplace",
  "a national healthcare marketing firm",
  "a top-tier agency coaching program",
  "a B2B lead generation firm",
